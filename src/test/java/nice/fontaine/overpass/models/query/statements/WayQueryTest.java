...
import static nice.fontaine.overpass.models.query.settings.Selection.*;
...
public class WayQueryTest {
    ...
    public void shouldQueryAround_whenCalled() {
        String expected = HEAD + "way[\"name\"=\"Gielgen\"](around:50.0,52.4,13.4)" + TAIL;

        WayQuery actual = new WayQuery.Builder()
    ...
    @Test public void shouldQueryBoundingBox_whenCalled() {
        String expected = HEAD + "way[\"name\"=\"Gielgen\"](50.6,7.0,50.8,7.3)" + TAIL;
    ...
    @Test public void shouldQueryPolygon_whenCalled() {
        String expected = HEAD + "way[\"name\"=\"Gielgen\"](poly:\"51.0 7.0 52.0 8.0 51.0 8.0\")" + TAIL;
    ...
    @Test public void shouldQueryArea_whenCalled() {
        String expected = HEAD + "area[\"name\"=\"Troisdorf\"];way(area)[\"highway\"][\"name\"]" + TAIL;
